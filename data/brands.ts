...
export const SeedBrandSchema = z.object({
  slug: z.string().min(3).max(100),
  name: z.string().min(1).max(100),
  description: z.string().min(1).max(500).optional(),
  websiteUrl: z.string().url().optional(),
...
export const dataBrands: SeedBrand[] = [
  {
    slug: "salomon",
    name: "Salomon",
    description: "French outdoor sports equipment company specializing in trail running and hiking gear.",
  ...
  },
  {
    slug: "asics",
    name: "ASICS",
    description: "Japanese multinational corporation which produces footwear and sports equipment.",
    websiteUrl: "https://www.asics.com",
    foundedYear: 1949,
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/ASICS_logo.svg/1200px-ASICS_logo.svg.png",
  },
  {
    slug: "nike",
    name: "Nike",
    ...
    foundedYear: 1964,
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Nike_Logo.svg/1200px-Nike_Logo.svg.png",
  },
  {
    slug: "adidas",
    name: "Adidas",
  ...
  },
  {
    ...
    foundedYear: 1948,
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/Puma_logo.svg/1200px-Puma_logo.svg.png",
  },
  {
    slug: "reebok",
    name: "Reebok",
    description: "British-American footwear and apparel company that is a subsidiary of Authentic Brands Group.",
    websiteUrl: "https://www.reebok.com",
    foundedYear: 1958,
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Reebok_logo.svg/1200px-Reebok_logo.svg.png",
  },
  {
    slug: "new-balance",
    name: "New Balance",
    description: "American multinational corporation that designs and manufactures athletic shoes and apparel.",
  ...
  },
  {
    slug: "brooks",
    name: "Brooks",
    description: "American sports equipment company that designs and markets running shoes, clothing and accessories.",
  ...
  },
  {
    slug: "saucony",
    name: "Saucony",
    description: "American athletic shoe company that specializes in running shoes.",
    websiteUrl: "https://www.saucony.com",
    foundedYear: 1898,
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Saucony_logo.svg/1200px-Saucony_logo.svg.png",
  },
  {
    slug: "hoka",
    name: "Hoka",
    description: "American footwear company that designs and manufactures running shoes.",
    websiteUrl: "https://www.hoka.com",
    foundedYear: 2009,
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Hoka_logo.svg/1200px-Hoka_logo.svg.png",
  },
  {
    slug: "mizuno",
    name: "Mizuno",
    ...
    foundedYear: 1906,
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Mizuno_logo.svg/1200px-Mizuno_logo.svg.png",
  },
  {
    slug: "under-armour",
    name: "Under Armour",
  ...
  },
  {
    slug: "altra",
    name: "Altra",
    description: "American footwear company that specializes in running shoes with a foot-shaped toe box.",
    websiteUrl: "https://www.altrarunning.com",
    foundedYear: 2011,
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Altra_logo.svg/1200px-Altra_logo.svg.png",
  },
  {
    slug: "merrell",
    name: "Merrell",
    description: "American footwear company that specializes in hiking and outdoor footwear.",
    websiteUrl: "https://www.merrell.com",
    foundedYear: 1981,
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Merrell_logo.svg/1200px-Merrell_logo.svg.png",
  },
  {
    slug: "910-running",
    name: "910 Running",
